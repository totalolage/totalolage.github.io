    ...
    <div className="flex flex-wrap gap-x-1">
      {badges.map((badge, index) => (
        <Badge
          key={index}
          {...badge}
          className={cn("inline", badge.className)}
        />
      ))}
    </div>
  );
...
// <Badge label="English C2" href="https://en.wikipedia.org/wiki/Common_European_Framework_of_Reference_for_Languages#Common_reference_levels" color="#C8102E" variant="flat-square" logo="" className="inline" />
// <Badge label="Czech native" href="https://en.wikipedia.org/wiki/Common_European_Framework_of_Reference_for_Languages#Common_reference_levels" color="#11457E" variant="flat-square" logo="" className="inline" />
...
// <Badge label="JavaScript" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" color="#F7DF1E" variant="plastic" logo="javascript" logoColor="black" className="inline" />
...
// <Badge label="React_Hook_Form" href="https://react-hook-form.com/" color="#EC5990" variant="plastic" logo="" className="inline" />
// <Badge label="Zod" href="https://zod.dev/" color="#EA4AAA" variant="plastic" logo="zod" logoColor="white" className="inline" />
// <Badge label="Zustand" href="https://zustand.surge.sh/" color="#FFBE58" variant="plastic" logo="" className="inline" />
...
// <Badge label="Emotion" href="https://emotion.sh/" color="#D36AC2" variant="plastic" logo="" className="inline" />
// <Badge label="TypeORM" href="https://typeorm.io/" color="#202021" variant="plastic" logo="" className="inline" />
...
// <Badge label="Copilot" href="https://copilot.github.com/" color="#8957E5" variant="plastic" logo="" className="inline" />
